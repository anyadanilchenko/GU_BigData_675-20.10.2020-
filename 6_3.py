...
one_worker = Position('Иван', 'Иванов', 'аналитик', 300, 500)
print(f'Сотрудник {one_worker.get_full_name()} работает {one_worker.position}')
print(f'Сотрудник {one_worker.get_full_name()} получает {one_worker.get_total_income()} р.')
